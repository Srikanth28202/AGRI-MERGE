// Static location data as fallback when API is unavailable
...
export const locationData = {
  ...
  "ARUNACHAL PRADESH": [
    ...
    "Siang", "Upper Siang", "Lower Dibang Valley", "Dibang Valley", "Anjaw",
  ...
  "CHHATTISGARH": [
    ...
    "Gariaband", "Janjgir-Champa", "Jashpur", "Kanker", "Kawardha",
  ...
  "JHARKHAND": [
    ...
    "Lohardaga", "Pakur", "Palamu", "Paschim Singhbhum", "Purbi Singhbhum",
    "Ranchi", "Ramgarh", "Sahebganj", "Seraikela Kharsawan", "Simdega"
  ],
  "KARNATAKA": [
    "BAGALKOTE", "BANGALORE RUR", "BANGALORE URB", "BELGAM", "BELLARY",
    "BIDAR", "BIJAPUR", "CHAMARAJANAGA", "CHICKBALLAPUR", "CHIKMAGALUR",
    "CHITRADURGA", "DAKSHIN KANDA", "DAVANGERE", "DHARWAD", "GADAG",
    "GULBARGA", "HAVERI", "HASSAN", "KODAGU", "KOLAR",
    "KOPPAL", "MANDYA", "MYSORE", "RAICHUR", "RAMNAGAR(BNGR)",
    "SHIMOGA", "TUMKUR", "UDUPI", "UTTAR KANNADA", "YADGIR"
  ],
  "KERALA": [
  ...
  "TAMIL NADU": [
    ...
    "Tirupathur", "Tiruppur", "Tiruvallur", "Tiruvannamalai", "Tirvarur",
  ...
  "UTTAR PRADESH": [
    ...
    "Sant Kabir Nagar", "Shahjahanpur", "Shravasti", "Siddharthnagar", "Sitapur",
